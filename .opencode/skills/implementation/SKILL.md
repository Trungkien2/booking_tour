---
name: implementation
description: Implement tasks according to Technical Design Documents (TDD) and task breakdown checklists for the Booking Tour project. Follows NestJS, Next.js, and Prisma patterns with strict TypeScript, writes tests, and updates task checklists.
