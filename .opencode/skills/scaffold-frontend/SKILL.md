...
description: Scaffold frontend code structure for the Booking Tour project using Next.js 16 App Router. Creates file structure and boilerplate only (pages, components, validation schemas, API functions) without complex business logic.
